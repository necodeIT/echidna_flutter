...
mixin _$EchidnaConfig {
  ...
  $EchidnaConfigCopyWith<EchidnaConfig> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $EchidnaConfigCopyWith<$Res> {
  factory $EchidnaConfigCopyWith(
          EchidnaConfig value, $Res Function(EchidnaConfig) then) =
      _$EchidnaConfigCopyWithImpl<$Res, EchidnaConfig>;
  @useResult
  $Res call({String baseUrl, String clientKey, int clientId});
}

/// @nodoc
class _$EchidnaConfigCopyWithImpl<$Res, $Val extends EchidnaConfig>
    implements $EchidnaConfigCopyWith<$Res> {
...
/// @nodoc
abstract class _$$EchidnaConfigImplCopyWith<$Res>
    implements $EchidnaConfigCopyWith<$Res> {
  factory _$$EchidnaConfigImplCopyWith(
          _$EchidnaConfigImpl value, $Res Function(_$EchidnaConfigImpl) then) =
      __$$EchidnaConfigImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({String baseUrl, String clientKey, int clientId});
}
...
/// @nodoc
class __$$EchidnaConfigImplCopyWithImpl<$Res>
    extends _$EchidnaConfigCopyWithImpl<$Res, _$EchidnaConfigImpl>
    implements _$$EchidnaConfigImplCopyWith<$Res> {
  __$$EchidnaConfigImplCopyWithImpl(
      _$EchidnaConfigImpl _value, $Res Function(_$EchidnaConfigImpl) _then)
      : super(_value, _then);
...
class _$EchidnaConfigImpl extends _EchidnaConfig {
  const _$EchidnaConfigImpl(
      {required this.baseUrl, required this.clientKey, required this.clientId})
      : super._();
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$EchidnaConfigImplCopyWith<_$EchidnaConfigImpl> get copyWith =>
      __$$EchidnaConfigImplCopyWithImpl<_$EchidnaConfigImpl>(this, _$identity);
}

abstract class _EchidnaConfig extends EchidnaConfig {
  const factory _EchidnaConfig(
      {required final String baseUrl,
      required final String clientKey,
      required final int clientId}) = _$EchidnaConfigImpl;
